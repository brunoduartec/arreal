...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\documentclass[oneside,18pt]{memoir} % Font size
...
\usepackage{pgffor} % Required for iterating through a list
\usepackage{etoolbox} % Required for dynamically changing chapter titles
...
\linespread{1.5} % Ajuste o fator conforme necessário para obter aproximadamente 30 linhas por página
...
\pagestyle{empty} % Set the page style to empty to remove page numbers
...
\makechapterstyle{Tufte}{ % Define a new chapter style
	...
	\renewcommand{\printchaptername}{} % Remove "Chapter" text
...
% Desativa a numeração de página
